      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-sm animate-fade-in">
          ...
          <button
            ...
            className="w-full h-11 bg-white hover:bg-slate-100 disabled:bg-white/50 text-slate-800 font-medium text-sm rounded-xl transition-all duration-200 flex items-center justify-center gap-2.5 cursor-pointer disabled:cursor-not-allowed border border-slate-200"
          >
            {isGoogleLoading ? (
              <Loader2 className="icon-sm animate-spin" />
            ) : (
